...
export class ApDataService {
  ...
  // const data = await this.http.get<Arbeitsplatz[]>(this.pageApsUrl + page).toPromise(); // 1. Teil, vollstaendiger
  // record this.dataService.get(this.allApsUrl).subscribe( (next) => {}, (err) => {}, () => {} );
