...
export class AdminOptionsComponent {
  ...
  public menu = [
    ...
    { route: ADM_APKAT_PATH, title: "Arbeitsplatz-Kategorien bearbeiten", text: "AP-Kategorien" },
    { route: ADM_APTYP_PATH, title: "Arbeitsplatz-Typen bearbeiten", text: "AP-Typen" },
    {
      route: ADM_EXTPROG_PATH,
      title: "Externe Programmaufrufe zu AP-Typen zuordnen",
      text: "Externe Programme",
    },
    { route: ADM_ADR_PATH, title: "Adressen für OEs bearbeiten", text: "Hausanschriften" },
    { route: ADM_HWTYP_PATH, title: "Hardware-Typen bearbeiten", text: "HW-Typen" },
    { route: ADM_OE_PATH, title: "Organisationseinheiten bearbeiten", text: "OE" },
    { route: ADM_TAGTYP_PATH, title: "Sonstige Informations-Typen bearbeiten", text: "TAG-Typen" },
