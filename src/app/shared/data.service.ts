...
export class DataService {
  ...
  public hwListReady = true; // TODO auf *false* ändern, sobald HW-List implementiert
  // public hwKonfigList: HwKonfig[] = [];
  public hwKonfigListReady = true; // TODO auf *false* ändern, sobald HW-KonfigList implementiert
